...
BattleMoveAnims['skullbreaker'] = { anim: BattleMoveAnims['stomp'].anim };
BattleMoveAnims['firepump'] = { anim: BattleMoveAnims['flamethrower'].anim };
...
BattleMoveAnims['brightidea'] = { anim: BattleMoveAnims['tailglow'].anim };
BattleMoveAnims['crazybolt'] = { anim: BattleMoveAnims['lusterpurge'].anim };
BattleMoveAnims['afrobreak'] = { anim: BattleMoveAnims['mistball'].anim };
BattleMoveAnims['frictionkick'] = { anim: BattleMoveAnims['blazekick'].anim };
BattleMoveAnims['crystalstorm'] = { anim: BattleMoveAnims['iciclespear'].anim };
BattleMoveAnims['poisonslash'] = { anim: BattleMoveAnims['poisontail'].anim };
BattleMoveAnims['wildbolt'] = { anim: BattleMoveAnims['volttackle'].anim };
BattleMoveAnims['furydance'] = { anim: BattleMoveAnims['dragondance'].anim };
BattleMoveAnims['pulsar'] = { anim: BattleMoveAnims['doomdesire'].anim };
BattleMoveAnims['curseclaw'] = { anim: BattleMoveAnims['psychoboost'].anim };