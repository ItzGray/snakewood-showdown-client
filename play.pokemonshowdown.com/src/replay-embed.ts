...
linkStyle('https://snakewoodshowdown.dynv6.net/style/font-awesome.css?');
linkStyle('https://snakewoodshowdown.dynv6.net/style/battle.css?a7');
linkStyle('https://snakewoodshowdown.dynv6.net/style/replay.css?a7');
linkStyle('https://snakewoodshowdown.dynv6.net/style/utilichart.css?a7');

requireScript('https://snakewoodshowdown.dynv6.net/js/lib/ps-polyfill.js');
requireScript('https://snakewoodshowdown.dynv6.net/config/config.js?a7');
requireScript('https://snakewoodshowdown.dynv6.net/js/lib/jquery-1.11.0.min.js');
requireScript('https://snakewoodshowdown.dynv6.net/js/lib/html-sanitizer-minified.js');
requireScript('https://snakewoodshowdown.dynv6.net/js/battle-sound.js');
requireScript('https://snakewoodshowdown.dynv6.net/js/battledata.js?a7');
requireScript('https://snakewoodshowdown.dynv6.net/data/pokedex-mini.js?a7');
requireScript('https://snakewoodshowdown.dynv6.net/data/pokedex-mini-bw.js?a7');
requireScript('https://snakewoodshowdown.dynv6.net/data/graphics.js?a7');
requireScript('https://snakewoodshowdown.dynv6.net/data/pokedex.js?a7');
requireScript('https://snakewoodshowdown.dynv6.net/data/moves.js?a7');
requireScript('https://snakewoodshowdown.dynv6.net/data/abilities.js?a7');
requireScript('https://snakewoodshowdown.dynv6.net/data/items.js?a7');
requireScript('https://snakewoodshowdown.dynv6.net/data/teambuilder-tables.js?a7');
requireScript('https://snakewoodshowdown.dynv6.net/js/battle-tooltips.js?a7');
requireScript('https://snakewoodshowdown.dynv6.net/js/battle.js?a7');
